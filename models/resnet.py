...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        if state_dict["fc.weight"].shape != model_dict["fc.weight"].shape:
            state_dict_new = {k:v for k,v in state_dict.items() if k in model_dict if "fc" not in k}
        else:
            state_dict_new = {k:v for k,v in state_dict.items() if k in model_dict}
